...
For a preview and documentation of the theme, visit: https://swiss.github.io/bootstrap-switzerland/
...
This includes a pre-built version of the theme that can be used as an NPM dependency in your project: `swiss/bootstrap-switzerland#gh-pages`
